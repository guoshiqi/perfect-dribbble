package com.ilovelonely.guoshiqi.dribbbleu.home.login;
...
public class LoginActivity extends BaseActivity implements LoaderCallbacks<Cursor> {
    ...
    private void sendAuthRequest(final String email,final String password){
        okHttpHelper= OkHttpHelper.getInstance();
        RequestParams params=new RequestParams();
        params.put("client_id", AppConstants.CLIENT_ID);
        params.put("redirect_uri","http://www.ilovelonely.com");
        params.put("scope","public+write+comment+upload");
        params.put("state","");
        okHttpHelper.get(ApiConstants.OAUTH_AUTH_URL, params, new Callback() {
            @Override
            ...
            public void onResponse(Call call, Response response) throws IOException {
                Bundle b=new Bundle();
                b.putString("url",response.networkResponse().request().url().toString());
                b.putString("email",email);
                b.putString("password",password);
                IntentUtils.gotoWebActivity(LoginActivity.this,b);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            sendAuthRequest(mEmail,mPassword);
